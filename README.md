...
A small academic GPT-style language model built with Python and PyTorch. It implements the core pieces of a local language model: tokenization, dataset batching, causal self-attention with RoPE, RMSNorm Transformer blocks, training, checkpointing, and sampling.
